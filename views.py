...
from .utils import (readlines_reverse, JSONResponseMixin)
...
class LogJsonView(JSONResponseMixin, TemplateView):
    ...
    def get_log_json(self, file_name=None, page=1):
        ...
        print(settings.LOG_VIEWER_FILES_DIR)
...
class LogViewerView(TemplateView):
    ...
    """
    template_name = "log_view/logfile_viewer.html"
    ...
    def get_context_data(self, file_name=None, page=1, **kwargs):
        ...
        context['custom_file_list_title'] = file_name if file_name else settings.LOG_VIEWER_FILE_LIST_TITLE
        print(context['custom_file_list_title'])
